...
## How we built it
I used an Arduino kit for it, that's it. I did the code in C++, used a little bit of AI (Claude code to be exact) and a little bit of calculator. I did the hardware simulation first. I simulated the hardware components in Wokwi which is a simulation app, I coded the project and uploaded it in Wokwi and once it worked, transferred the hardware into real life, used the same code and it worked.
